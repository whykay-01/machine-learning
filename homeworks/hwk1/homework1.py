...
if __name__ == "__main__":
    ...
    population_plot = plot_freq_dist(
        population_col, color="red", title="population plot"
    )
    households_plot = plot_freq_dist(
        households_col, color="green", title="households plot"
    )
